...
class AIAnalysisService:
    ...
    async def analyze_consolidated(self, messages: list[dict[str, Any]], analysis_period: str,
        ...
        parts = [
            ...
            "context. T+1 written only in notes_ar, notes_summary, or other generated prose is not evidence. Reject every translation, "
            "synonym, paraphrase, or inferred next-day meaning. "
